...
Please watch over and protect ${namesString}. Guide them with Your wisdom, fill their hearts with Your love, and bless them with Your grace.${
    intentionsString
...
export default function PrayerTrackerScreen() {
  ...
  const [tempCompletedPrayers, setTempCompletedPrayers] = useState<Set<string>>(
    new Set()
  );
  ...
  const [savedPrayers, setSavedPrayers] = useState<
    { prayer: string; timestamp: number }[]
  >([]);
  ...
  const [inputMode, setInputMode] = useState<"text" | "microphone">(
    "microphone"
  );
    ...
    React.useCallback(() => {
      const loadPrayerData = async () => {
        try {
          ...
          const savedPrayerNamesData = await AsyncStorage.getItem(
            "prayerNames"
          );
  ...
  const uploadAudio = async (audioUri) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://realtime-3d-server.fly.dev/api/transcribe",
        {
          method: "POST",
          body: formData,
        }
      ...
      <View style={styles.inputModeToggle}>
        ...
        >
          <Ionicons
            name="mic-outline"
            size={20}
            color={inputMode === "microphone" ? "#fff" : Colors.light.primary}
          />
          <Text
            style={[
              styles.toggleButtonText,
              inputMode === "microphone" && styles.activeToggleText,
            ]}
          ></Text>
        </TouchableOpacity>
        ...
        >
          <Ionicons
            ...
            size={20}
            color={inputMode === "text" ? "#fff" : Colors.light.primary}
          />
          <Text
            style={[
              styles.toggleButtonText,
              inputMode === "text" && styles.activeToggleText,
            ]}
          ></Text>
        </TouchableOpacity>
      </View>
          ...
          {micPermission === false && inputMode === "microphone" ? (
            ...
            <View style={styles.permissionContainer}>
              ...
              <Text style={styles.permissionText}>
                To use voice input for your prayers, we need access to your
                microphone.
              </Text>
              <TouchableOpacity
              ...
              <TouchableOpacity
                ...
                onPress={() => setInputMode("text")}
              >
                <Text style={styles.textModeButtonText}>
            ...
            <>
              ...
              <Text
                style={[styles.instructionsLabel, styles.secondSectionTitle]}
              >
              ...
              <TextInput
                ...
                placeholder={
                  language === "en"
                    ...
                    : language === "es"
                    ? "Ingresa tus intenciones de oración aquí..."
                    : language === "hi"
                    ? "अपनी प्रार्थना इरादों यहां दर्ज करें..."
                    : language === "pt"
                    ? "Digite suas intenções de oração aqui..."
                    : language === "id"
                    ? "Masukkan niat doa Anda di sini..."
                    : language === "fr"
                    ? "Entrez vos intentions de prière ici..."
                    : "Enter your prayer intentions here..."
                }
